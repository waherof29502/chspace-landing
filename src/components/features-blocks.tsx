      ...
      <div className='relative max-w-6xl mx-auto px-4 sm:px-6'>
        <div className='py-12 md:py-20'>
          ...
          <div className='max-w-3xl mx-auto text-center pb-12 md:pb-20'>
            <h2 className='mb-4 font-syne'>Explore the solutions</h2>
            <h3 className='mb-3 font-syne text-gray-600'>This is apple 中文</h3>
            <h3 className='mb-3 font-sans text-gray-600'>This is apple 中文</h3>
            <h3 className='mb-3 font-sansCjk text-gray-600'>
              This is apple 中文
            </h3>

            <p className='text-xl font-sansCjk text-gray-600'>
