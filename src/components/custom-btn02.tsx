...
export default function CustomBtn02({title,fontType}:ButtonProps) {
  return (
     <button className='flex mx-12 my-[10px] md:my-0 py-[60px] wide:py-0 transition-all'>
        ...
        <div className="relative -ml-[80px]  rounded-full border-[1.5px] border-primary border-solid w-[50px] h-[50px] ease-linear group-hover:bg-black duration-300" />
        <div className="relative -ml-[120px] w-0 group-hover:w-4 h-[1.2px] bg-blue-200 transform transition-transform group-hover:ease-linear group-hover:translate-x-2 duration-300 group-hover:animate-in" />
        </div>
</button>
  );
}
