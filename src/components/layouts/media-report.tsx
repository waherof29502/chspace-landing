        ...
        <div className="py-2 3md:px-12 xl:p-12 wide:p-20 w-full">
            ...
            >
              {NEWS_FILTER_LISTS.map((item) => (
                ...
                >
                  <Link href={item.path}>
                  <span className={`tracking-wider font-sansCjk text-[1.125rem] md:text-[0.75rem] lg:text-[1rem] wide:text-[1.375rem] ${activeCategory ===item.category ?"text-primary" :'text-[#888]'}  text-[#888] font-semibold hover:text-primary`}>
                    {item.title}
                  </span>
                  </Link>
                </button>
            ...
            <div
              className={`md:hidden grid grid-cols-2 gap-y-5 font-serif text-primary my-5 items-start ${
                !top
                  ? 'fixed bg-white top-[5rem] -left-[2px] h-[6vh] w-full z-10 py-3'
                  : ''
              }`}
            >
              {NEWS_FILTER_LISTS.map((item) => (
                <button
                 ...
                 >
                  <Link href={item.path}>
                  <span className={`tracking-wider font-sansCjk text-[1.125rem] md:text-[0.75rem]  ${activeCategory ===item.category ?"text-primary" :'text-[#888]'}  text-[#888] font-medium md:font-semibold hover:text-primary`}>
                    {item.title}
                  </span>
                  </Link>
                </button>
              ...
              >
                <Link href={`/new1`}>
                  ...
                  <div className="flex justify-between w-full ">
                    <span className="font-sansCjk text-[0.875rem] text-[#464646] tracking-[0.42px] pt-5">{item.tag}</span>
                    <span className="font-syne text-[0.875rem] text-[#464646] tracking-[0.42px] pt-5">{item.date}</span>
                  </div>
