          ...
          <div className="py-2 3md:py-10 lg:py-20">
            ...
            <div
              className={`hidden md:flex flex-row justify-center items-center text-primary font-serif mt-10 -mb-[20px] 3md:mt-0 3md:mb-10  ${
                !top
                  ? 'fixed bg-white top-[50px] 3md:top-[12vh] 3xl:top-[10vh] -left-[8px] md:h-18 xl:h-20 w-full z-10 flex flex-row justify-center items-center py-4 px-2 '
                  : ''
              }`}
            >
            ...
            >
              {PORTFOLIO_FILTER_LISTS.map((item) => (
                <button
                 ...
                 >
                <Link href={item.path}>
                  <span className={`tracking-wider font-sansCjk text-[1.125rem] md:text-[12px]  ${activeCategory ===item.category ?"text-primary" :'text-[#888]'}  text-[#888] font-semibold hover:text-primary`}>
                    {item.title}
                  </span>
                  </Link>
                </button>
