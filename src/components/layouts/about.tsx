  ...
  return (
    <>
      <section className='relative overflow-hidden'>
        ...
        <h1 className='text-[16px] md:text-[24px] font-sansCjk font-medium tracking-[2.08px] md:tracking-[2.4px]'>文域設計創立於2017年，深耕文化場域</h1>
        <p className='text-[#464646] text-[16px] font-sansCjk font-normal tracking-[1.76px] leading-[39px] xl:pr-[100px] py-5 md:pt-10 md:pb-0 xxxl:py-20'>以”文化創生”為核心理念，致力於文化、藝術和商業的有機融合，建構室內外的空間場域，藉由場域精神傳達文化價值，提升生活美學及品味。 我們專注於高端商業的綜合服務，包括商業空間升級以打造城市文化地標、文化空間企劃與設計、文化內容策劃等，透過淬鏈、創意、多元的設計概念及操作手法，以最純粹的方式，表現品牌價值及故事。</p>
        ...
        <p className={`text-primary translate-x-13 font-syne text-[16px] tracking-[1.48px] transition-all  group-hover:translate-x-12 ease-linear duration-800`}>more service</p>
        ...
        <Image className='w-full mx-auto mb-0 md:mb-20 mt-10 xl:mt-[200px] rounded-md' src={Image04} alt='about-chsapce' width={804} height={497} />
    ...
    {/* Section 以設計閱讀世界  desktop*/}
      <div className='relative pr-10 pl-10 pb-[40px]'>
        ...
        <div className='relative bg-fit w-full h-auto lg:h-[991px] mt-[120px]' style={{ backgroundImage: `url(${NewsBg.src})` }}>
        <div className='flex flex-col justify-start item-center w-[80%] mx-auto pb-10'>
         <div className='flex flex-row md:justify-start items-center pt-[50px] pb-[10px] lg:py-[50px]'>
              ...
              <span className='pl-4 mt-1.5 font-sansCjk text-[#545351] text-[16px] lg:text-[18px]'>
               設計歷程
              </span>
        </div>
        <div className='flex flex-col md:grid md:grid-cols-2 gap-10 '>
            <div className='flex flex-col'>
            <h3 className='text-primary text-[16px] lg:text-[24px] tracking-[2.64px] font-sansCjk py-8'>年度大事</h3>
            <div className="flex flex-col justify-start gap-y-12 ">
                {ANNUALEVENTS.map((item) => (
                    <div key={item.id} className="flex flex-col md:flex-row text-primary w-full items-start leading-[42px]">
                    <p className="text-[#464646] text-[14px] lg:text-[18px] font-sansCjk font-extrabold tracking-[1.98px]">{item.year}</p>
             ...
             <div className='flex flex-col'>
            <h3 className='text-primary text-[16px] lg:text-[24px] tracking-[2.64px] font-sansCjk py-8'>獲獎紀錄</h3>
            <div className="flex flex-col justify-start gap-y-12">
          ...
          <div className="xl:hidden flex justify-end w-2/3 lg:w-full ml-auto mt-[40px] -mr-[40px] md:-mr-[100px]">
            ...
            <Image src={TEAMIMAGE[0].src} width={285} height={367} alt={TEAMIMAGE[0].title} className='rounded-sm lg:ml-14 xl:ml-0'/>
            <div className='flex flex-col p-4 md:p-10 lg:p-20 items-center lg:items-start'>
            <div className='flex flex-row items-center'>
            <p className='text-primary tracking-[12.98px] text-[18px] pt-4 [writing-mode:vertical-lr] '>{TEAMIMAGE[0].title.slice(0,3)}</p>
            ...
            <p className='text-[#464646] leading-[35px] tracking-[1.76px] text-[16px] pt-2 lg:pr-[10px]  xxxl:pr-[20px] wider:pr-[300px]'>{TEAMIMAGE[0].desc}</p>
            </div>
            </div>
