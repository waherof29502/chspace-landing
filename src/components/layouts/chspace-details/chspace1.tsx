...
//       ]
//     }
export default function Chspace1() {
  return (
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="px-10 lg:px-[180px] 3xl:px-[420px] py-5">
              ...
              <div className="flex flex-col justify-start py-10">
                ...
                <p className="text-[#464646] text-[0.875rem] font-sansCjk tracking-[1.54px] leading-[33px]">
                我們提出「共享設計工作室」的想法，邀請幾位設計工作者一同加入進駐，藉由共享的概念解決空間機能重複的問題，例如會議室、材料室、事務區及茶水間等，如此一來，既能滿足工作室的機能需求，同時也能大幅降低營運成本、提升空間的使用率。此外，剝離辦公室制式的框架，伴隨著綠意與書香的舒心環境，以工作融於生活的理念，催生出全新的辦公體驗，我們期望讓員工在努力投入工作時，依然保持身心健康、每天充滿幸福感。而悠閒的庭院環境、愜意的書店氛圍，如此細膩有溫度的空間，促使了街坊鄰居前來交流互動，經由分享生活的美和感動，讓這股溫暖在社區間蔓延開來。                </p>
              </div>
               <Image
                className="mx-auto rounded-md pt-10 wider:w-[1920px]"
                src={CONTENTIMG[7]}
