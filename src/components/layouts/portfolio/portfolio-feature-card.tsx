  ...
  return (
     <div className={`mx-auto md:mt-[97px] mb-10 md:mb-[160px] flex flex-1 flex-col`}>
      ...
      <div className='flex justify-start mt-12 p-2 md:p-0'>
       <div className='hidden md:flex items-center border-[1.5px] border-primary border-solid rounded-xl w-[68px] h-[78px] pl-[12px] pr-[1px] md:pl-[7px] md:pr-[1px] lg:pl-[12px] md:mr-10 mr-4'>
        <span className='text-[12px] font-sansCjk md:text-[16px] lg:text-[18px] text-primary font-semibold' >
          {category}
        </span>
        </div>
        
        <div className='text-primary font-sans w-full md:w-[920px] pt-8 -mt-[29px] md:-mt-[45px] md:pt-[50px]'>
