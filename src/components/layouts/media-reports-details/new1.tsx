          ...
          <div className="flex flex-col justify-center">
            <div className="flex flex-col justify-start px-10 lg:px-[150px] 3xl:px-[350px] pb-10 3xl:pb-[60px]">
              ...
              <div className="flex flex-row">
                ...
                <span className="text-primary text-[0.875rem] font-sansCjk tracking-[0.48px] px-3">
                 來源：T客邦
                </span>
              </div>
            </div>
            ...
            <div className="px-10 lg:px-[180px] 3xl:px-[420px] py-5">
              ...
              <div className="flex justify-start items-center">
                <p className="text-[#464646] text-[0.875rem] font-sansCjk tracking-[1.54px] leading-[33px]">
                  媒體報導連結：
                  <a href="https://www.techbang.com/posts/102712-interview-with-xie-zhenyu-design-feat-canon-gx4070" target="_blank" className="hover:text-primary font-syne cursor-pointer">
