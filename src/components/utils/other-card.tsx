        ...
        <div className="relative overflow-hidden rounded-lg">
          <div className="flex flex-col">
            ...
            <div className="flex flex-col items-start mt-6 lg:mt-2 xl:flex-row xl:items-center 3xl:flex-col 3xl:items-start ">
              <p className="text-[12px] md:text-[14px] 3xl:text-[16px]  text-primary font-semibold tracking-[1.8px]">
                {title}
              </p>
              <p className="mt-2 md:mt-0 lg:mt-[1px] xl:ml-2 3xl:ml-0 text-[10px] md:text-[12px] font-sansCjk font-normal  text-[#464646]">
                {desc}
              </p>
            </div>
          </div>
