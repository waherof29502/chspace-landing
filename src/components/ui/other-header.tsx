  ...
  return (
    ...
    >
      <div className="h-[100px] md:h-auto max-w-8xl mx-auto px-10 sm:px-6 lg:px-8 xl:px-[140px]">
        <div className="flex items-center justify-between h-16 pt-6 pr-2 md:h-[120px] lg:h-[100px] 3xl:h-40">
          <Logo top={top} />

          {/* Desktop navigation */}
          <nav className="hidden md:flex md:grow">
            <ul className="flex grow font-syne justify-end items-center -mt-[42px] text-[16px] md:text-[14px] lg:text-[16px]">
              {NAV_ITEMS.map((item) => (
                <li key={item.id}>
                  <Link
                    href={item.link}
