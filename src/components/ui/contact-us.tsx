            ...
            <div className='lg:ml-10 py-12 md:mr-10 lg:mr-[60px] xl:px-10 sm:mr-5 mr-0 my-5 '>
              <div className='ml-4 flex flex-row md:flex-col justify-center items-center'>
                ...
                <div className='flex flex-col ml-[21px] md:ml-0 mt-0 md:mt-[50px] gap-4'>
                  <span className='text-primary  hover:text-gray-600 text-[16px] md:text-[14px] md:whitespace-pre lg:text-[16px] '><a href='tel:+886-2-27386876' >TEL:+886-2-27386876</a></span>
                  <span className='text-primary text-[16px] md:text-[14px] lg:text-[16px] md:whitespace-pre  '>FAX:+886-2-27386878</span>
                </div>
              </div>
            </div>
          </div>
