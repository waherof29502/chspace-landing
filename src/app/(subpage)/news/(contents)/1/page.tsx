          ...
          <div className="flex flex-col justify-center">
            <div className="flex flex-col justify-start px-10 lg:px-[150px] 3xl:px-[350px] pb-10 3xl:pb-[60px]">
              ...
              <div className="flex flex-row">
                <span className="text-primary text-[16px] font-sansCjk tracking-[0.48px] pr-3 border-[#C4C4C4] border-r-[1.5px] border-solid">
                  {MEDIAREPORT[0].tag}
                </span>
                <span className="text-primary text-[16px] font-syne tracking-[0.48px] px-3">{MEDIAREPORT[0].date}</span>
                <span className="text-primary text-[16px] font-sansCjk tracking-[0.48px] px-3">
                  {MEDIAREPORT[0].resource}
                </span>
              </div>
            </div>
            <div className="px-10 lg:px-[180px] 3xl:px-[420px] py-5">
              ...
              <Image
                ...
                height={647}
              />
              <p className="text-[#464646] text-[14px] font-sansCjk tracking-[1.54px] text-center leading-[33px] pt-5 pb-1">
                {MEDIAREPORT[0].content?.caption[0]}
              </p>
              <Image
                className="mx-auto rounded-md pt-10 wider:w-[1920px]"
              ...
              />
              <p className="text-[#464646] text-[14px] font-sansCjk tracking-[1.54px] text-center leading-[33px] pt-5 pb-1">
                {MEDIAREPORT[0].content?.caption[1]}
              </p>
              <div className="flex flex-col justify-start">
                <h2 className="text-primary text-[20px] font-medium tracking-[2.2px] pt-10 pb-6">
                  {MEDIAREPORT[0].content?.title[1]}
                </h2>
                <p className="text-[#464646] text-[14px] font-sansCjk tracking-[1.54px] leading-[33px]">
                  {MEDIAREPORT[0].content?.desc[1]}
                </p>
              </div>
              <Image
                className="mx-auto rounded-md pt-10 wider:w-[1920px]"
              ...
              <div className="flex flex-col justify-start py-10">
                <p className="text-[#464646] text-[14px] font-sansCjk tracking-[1.54px] leading-[33px]">
                  {MEDIAREPORT[0].content?.desc[2]}
                </p>
              </div>
              <div className="flex justify-start items-center">
                <p className="text-[#464646] text-[14px] font-sansCjk tracking-[1.54px] leading-[33px]">
                  媒體報導連結：
                  <a href={MEDIAREPORT[0].content?.desc[3]} target="_blank" className="hover:text-primary font-syne">
                    {MEDIAREPORT[0].content?.desc[3]}
                  </a>
                </p>
              </div>
